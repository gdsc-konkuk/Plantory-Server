...
class PlantRecordTest {
    ...
    @ValueSource(
        strings = [
            ...
            "https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2Fbbw4Az%2FbtsbCHvGUfF%2FwLs50sdYRtik8iaR6I3KEK%2Fimg.png",
            "www.naver.com"]
    )
    fun `데일리 기록 생성`(uri: String) {
    ...
    fun `기록 길이 제한 초과하면 예외를 반환`() {
        // length: 301
        val tooLongComment = "https://www.google.com/search?q=%EC%95%88%EB%8dsfajaslkfjasdkfjkldsafjlsadkjf" +
    ...
    @Test
    fun `사진 url 길이 제한 초과하면 예외를 반환`() {
        // length: 1001
        val tooLongUrl = "https://www.google.com/search?q=%EC%95%88%EB%8dsfajaslkfjasdkfjkldsafjlsadkjf" +
                "lksajfldkadsfajaslkfjasdkfjkldsafjlsadkjflksajfldkajlafkj;lkdjalkfjads;jfalksdfjlasjf;" +
                "ljlfsaddsfajaslkfjasdkfjkldsafjlsadkjflksajfldkajlafkj;lkdjalkfjads;jfalksdfjlasjf;ljlf" +
        ...
        assertThrows<IllegalArgumentException> { PlantRecord(tooLongUrl, "test_comment") }
    }
}
